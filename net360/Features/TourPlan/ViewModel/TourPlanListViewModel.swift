...
class TourPlanListViewModel: ObservableObject {
    ...
    func fetchDummyDataForEventList() {
        let events: [Event] = [
            Event(id: 1, cityName: "Bern", totalEvents: 6, startDate: "26-08-2024", endDate: "29-08-2024", location: "Allmend", venue: "Venue 1", eventDuration: 3, eventIsForToday: true, daysToStartEvent: 4),
            Event(id: 2, cityName: "Basel", totalEvents: 2, startDate: "27-08-2024", endDate: "30-08-2024", location: "Allmend", venue: "Venue 2", eventDuration: 3, eventIsForToday: false, daysToStartEvent: 7),
